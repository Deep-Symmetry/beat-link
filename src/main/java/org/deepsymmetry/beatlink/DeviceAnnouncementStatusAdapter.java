 ...
 *
 * <p>Extend this class to create a {@link DeviceAnnouncementStatusListener} and override only the methods for events that you
 * care about. If you plan to implement all the methods in the interface, you might as well implement
 * {@link DeviceAnnouncementStatusListener} directly.</p>
 *
